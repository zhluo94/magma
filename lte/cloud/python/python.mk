...
install_virtualenv:
	...
	virtualenv --python=/usr/bin/python$(PYTHON_VERSION) $(PYTHON_BUILD) # get rid of --system-site-packages
...
$(PROTO_LIST): %_protos:
	...
	$(BIN)/python $(SRC)/lte/cloud/python/gen_protos.py $(SRC)/$*/protos/ $(MAGMA_ROOT),$(MAGMA_ROOT)/orc8r/protos/prometheus $(SRC) $(PYTHON_BUILD)/gen/

prometheus_proto:
	$(BIN)/python $(SRC)/lte/cloud/python/gen_prometheus_proto.py $(MAGMA_ROOT) $(PYTHON_BUILD)/gen
